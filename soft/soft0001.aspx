<%@ Page Language="C#" MasterPageFile="~/soft/soft.master" AutoEventWireup="true" CodeFile="soft0001.aspx.cs" Inherits="soft_soft0001" %>
                ...
                <table width="460" border="0" cellpadding="0" cellspacing="0" id="BODY_01">
                    ...
                    <tr>
                        <td style="height: 40px;" align="right">
                            <asp:HyperLink ID="SoftJnlp" runat="server">在线使用</asp:HyperLink>
                            &nbsp;&nbsp;
                            <asp:HyperLink ID="SoftDown" runat="server">软件下载</asp:HyperLink>
                        </td>
                    </tr>
                </table>
            </td>
