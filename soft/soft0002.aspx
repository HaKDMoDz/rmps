<%@ Page Language="C#" MasterPageFile="~/soft/soft.master" AutoEventWireup="true" CodeFile="soft0002.aspx.cs" Inherits="soft_soft0002" %>
                            ...
                            <tr>
                                ...
                                <td width="30" align="left" valign="top">
                                    ...
                                    <% 
                                        ...
                                        {
                                    %>
                                    <a href="soft9999.aspx?sid=<%#Eval(cons.io.db.comn.ComnCons.C0010104)%>&ver=<%#Eval(cons.io.db.comn.ComnCons.C0010105)%>" title="编辑软件信息">编辑</a>
                                    <% 
                                        }
                                    %>
                                </td>
