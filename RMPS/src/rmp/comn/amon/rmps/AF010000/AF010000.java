 ...
 *
 */
package rmp.comn.amon.rmps.AF010000;
...
import rmp.Rmps;
import rmp.comn.amon.rmps.AF010000.v.MainPanel;
import rmp.comn.amon.rmps.AF010000.v.MiniPanel;
import rmp.comn.amon.rmps.AF010000.v.NormPanel;
import rmp.comn.amon.rmps.AF010000.v.SubMenu;
import rmp.comn.amon.rmps.AF010000.v.TailPanel;
 ...
 * @author Amon
 */
public class AF010000 extends WForm implements IPrpPlus
{
    // ////////////////////////////////////////////////////////////////////////
    // 控制变量区域
    // ////////////////////////////////////////////////////////////////////////
    ...
    public void wShowHelp()
    {
        ...
        {
            Logger.getLogger(AF010000.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    public static String getMesg(String mesgId)
    {
        if (langRes == null)
        {
            ...
            try
            {
                FileUtil.readLangRes(langRes, EnvCons.PATH_AF010000, EnvCons.COMN_SOFT_LANG);
            }
            catch (Exception exp)
            {
