...
import rmp.comn.rmps.C4010000.v.MainPanel;
import rmp.comn.rmps.C4010000.v.MiniPanel;
import rmp.comn.rmps.C4010000.v.NormPanel;
import rmp.comn.rmps.C4010000.v.SubMenu;
...
public class C4010000 extends WForm implements IPrpPlus
{
    ...
    /** 当前显示面板 */
    private javax.swing.JPanel vp_CurrPanel;
    ...
    public void wShowHelp()
    {
        ...
        {
            Logger.getLogger(C4010000.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    {
        C1010000.setInfo(EnvUtil.getLangPath(EnvCons.COMN_SOFT_INFO, "C4010000", baseFolder));
    ...
    public static String getMesg(String mesgId)
    {
        if (langRes == null)
        {
            ...
            try
            {
                FileUtil.readLangRes(langRes, EnvUtil.getLangPath(EnvCons.COMN_SOFT_LANG, "C4010000", baseFolder));
            }
            catch (Exception exp)
            {
     ...
     * @return
     */
    public javax.swing.JPanel getAd()
    {
        return vp_CurrPanel;
    }
    ...
    {
        Util.setAdFilePath(new File(adFilePath));
    }

    /**
     * @param adFilePath
     */
    public void setAdFilePath(File adFilePath)
    {
        Util.setAdFilePath(adFilePath);
    }
