...
public class SoftUserData extends WUserData
{
    ...
    public boolean setExtsList(String extsList)
    {
        ...
        if (!validate)
        {
            errMsg = StringUtil.format(LangRes.MESG_CHCK_0002, LangRes.SOFT_COMN_TEXT_SOFTEXTS, "" + DB0008.SOFTDATA_EXTSLIST_SIZE);
            return false;
        }
    ...
    public boolean setSoftDesp(String softDesp)
    {
        ...
        if (!validate)
        {
            errMsg = StringUtil.format(LangRes.MESG_CHCK_0002, LangRes.SOFT_COMN_TEXT_SOFTDESP, "" + DB0008.SOFTDATA_SOFTDESP_SIZE);
            return false;
        }
    ...
    public boolean setSoftMail(String softMail)
    {
        ...
        if (!validate)
        {
            errMsg = StringUtil.format(LangRes.MESG_CHCK_0002, "LangRes.TEXT_SOFTMAIL", "" + DB0008.SOFTDATA_SOFTMAIL_SIZE);
            return false;
        }
    ...
    public boolean setSoftName(String softName)
    {
        ...
        if (!validate)
        {
            errMsg = StringUtil.format(LangRes.MESG_CHCK_0002, "LangRes.TEXT_SOFTNAME", "" + DB0008.SOFTDATA_SOFTNAME_SIZE);
            return false;
        }
    ...
    public boolean setSoftSite(String softSite)
    {
        ...
        if (!validate)
        {
            errMsg = StringUtil.format(LangRes.MESG_CHCK_0002, LangRes.SOFT_COMN_TEXT_SOFTSITE, "" + DB0008.SOFTDATA_SOFTSITE_SIZE);
            return false;
        }
