...
public class FileUserData extends WUserData
{
    ...
    public boolean setCipherSn(String cipherSn)
    {
        ...
        if (!validate)
        {
            errMsg = StringUtil.format(LangRes.MESG_CHCK_0002, LangRes.FILE_COMN_TEXT_CIPHERSN, "" + DB0008.FILEDATA_CIPHERSN_SIZE);
            return false;
        }
    ...
    public boolean setFileDesp(String fileDesp)
    {
        ...
        if (!validate)
        {
            errMsg = StringUtil.format(LangRes.MESG_CHCK_0002, LangRes.FILE_COMN_TEXT_FILEDESP, "" + DB0008.FILEDATA_FILEDESP_SIZE);
            return false;
        }
    ...
    public boolean setFileIcon(String fileIcon)
    {
        ...
        if (!validate)
        {
            errMsg = StringUtil.format(LangRes.MESG_CHCK_0002, "LangRes.TEXT_FILEICON", "" + DB0008.FILEDATA_FILEICON_SIZE);
            return true;
        }
    ...
    public boolean setFootData(String footData)
    {
        ...
        if (!validate)
        {
            errMsg = StringUtil.format(LangRes.MESG_CHCK_0002, "LangRes.TEXT_FOOTDATA", "" + DB0008.FILEDATA_FOOTDATA_SIZE);
            return false;
        }
    ...
    public boolean setFormatDt(String formatDt)
    {
        ...
        if (!validate)
        {
            errMsg = StringUtil.format(LangRes.MESG_CHCK_0002, "LangRes.TEXT_FORMATDT", "" + DB0008.FILEDATA_FORMATDT_SIZE);
            return false;
        }
    ...
    public boolean setHeadData(String headData)
    {
        ...
        if (!validate)
        {
            errMsg = StringUtil.format(LangRes.MESG_CHCK_0002, "LangRes.TEXT_HEADDATA", "" + DB0008.FILEDATA_HEADDATA_SIZE);
            return false;
        }
    ...
    public boolean setSignChar(String signChar)
    {
        ...
        if (!validate)
        {
            errMsg = StringUtil.format(LangRes.MESG_CHCK_0002, LangRes.FILE_COMN_TEXT_SIGNCHAR, "" + DB0008.FILEDATA_SIGNCHAR_SIZE);
            return false;
        }
    ...
    public boolean setSignCode(String signCode)
    {
        ...
        if (!validate)
        {
            errMsg = StringUtil.format(LangRes.MESG_CHCK_0002, LangRes.FILE_COMN_TEXT_SIGNCHAR, "" + DB0008.FILEDATA_SIGNCODE_SIZE);
            return false;
        }
