/*
 * FileName:       AsocPanel.java
 * CreateDate:     Jul 9, 2007 9:20:24 AM
 * ProjectName:    RMPS
 ...
 * </p>
 * <p>
 * 日期： Jul 9, 2007 9:20:24 AM
 * </p>
 * <p>
 * 团队： WinShine开发团队
 * </p>
 */
public class AsocPanel extends javax.swing.JPanel implements WBackCall
{
    // ////////////////////////////////////////////////////////////////////////
    // 界面控制变量区域
    // ////////////////////////////////////////////////////////////////////////
    /**  */
    private static final long serialVersionUID = 205888714364198548L;
    /** 当前状态是否为可交互状态 */
     ...
     * @param soft
     */
    public AsocPanel(Extparse soft)
    {
        me_MainSoft = soft;
    }
    ...
    {
        List<K2SV1S> softList = SoftPanel.queryByName("", softName);
    ...
    private void ica()
    {
        ...
        layout.setHorizontalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(
            layout.createSequentialGroup().addContainerGap().addComponent(sp_AsocSoft,
                ...
                layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addComponent(lb_AsocSoft)
                    .addComponent(lb_AsocDesp).addGroup(
            ...
            layout.createSequentialGroup().addContainerGap(137, Short.MAX_VALUE).addComponent(bt_Create)
                ...
                layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false).addComponent(sp_AsocSoft,
                    ...
                    layout.createSequentialGroup().addComponent(lb_AsocSoft).addPreferredGap(
                        ...
                        layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE).addComponent(
                            ...
                            javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE,
                            javax.swing.GroupLayout.PREFERRED_SIZE)).addPreferredGap(
                        javax.swing.LayoutStyle.ComponentPlacement.UNRELATED).addComponent(lb_AsocDesp)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED).addComponent(sp_AsocDesp,
                            javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE,
                            javax.swing.GroupLayout.PREFERRED_SIZE))).addPreferredGap(
            ...
            if (!isDataUpdt)
            {
                ...
                for (int i = 0, j = lm_AsocSoft.size(); i < j; i += 1)
                {
                    ...
                    if (softHash == kvItem.getK())
                    {
                        ...
                        if (0 != MesgUtil.showConfirmDialog(this, msg))
                        {
                            return;
                        }
