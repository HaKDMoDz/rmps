/*
 * FileName:       CorpUserData.java
 * CreateDate:     Jul 4, 2007 2:36:47 PM
 * ProjectName:    RMPS
...
public class CorpUserData extends WUserData
{
    ...
    public boolean setCorpDesp(String corpDesp)
    {
        ...
        if (!validate)
        {
            errMsg = StringUtil.format(LangRes.MESG_CHCK_0002, LangRes.CORP_COMN_TEXT_CORPDESP, ""
                + DB0008.CORPDATA_CORPDESP_SIZE);
            return false;
        }
    ...
    public boolean setCorpEnNm(String corpEnNm)
    {
        ...
        if (!validate)
        {
            errMsg = StringUtil.format(LangRes.MESG_CHCK_0002, LangRes.CORP_COMN_TEXT_CORPENNM, ""
                + DB0008.CORPDATA_CORPENNM_SIZE);
            return false;
        }
    ...
    public boolean setCorpLcNm(String corpLcNm)
    {
        ...
        if (!validate)
        {
            errMsg = StringUtil.format(LangRes.MESG_CHCK_0002, LangRes.CORP_COMN_TEXT_CORPLCNM, ""
                + DB0008.CORPDATA_CORPLCNM_SIZE);
            return false;
        }
    ...
    public boolean setCorpSite(String corpSite)
    {
        ...
        if (!validate)
        {
            errMsg = StringUtil.format(LangRes.MESG_CHCK_0002, LangRes.CORP_COMN_TEXT_CORPSITE, ""
                + DB0008.CORPDATA_CORPSITE_SIZE);
            return false;
        }
