/*
 * FileName:       IdioUserData.java
 * CreateDate:     Jul 4, 2007 2:41:09 PM
 * ProjectName:    RMPS
...
public class IdioUserData extends WUserData
{
    ...
    public boolean setHomePage(String homePage)
    {
        ...
        if (!validate)
        {
            errMsg = StringUtil.format(LangRes.MESG_CHCK_0002, "LangRes.TEXT_SOFTSITE", ""
                + DB0008.IDIODATA_HOMEPAGE_SIZE);
            return false;
        }
    ...
    public boolean setIdioDesp(String idioDesp)
    {
        ...
        if (!validate)
        {
            errMsg = StringUtil.format(LangRes.MESG_CHCK_0002, "LangRes.TEXT_IDIODESP", ""
                + DB0008.IDIODATA_IDIODESP_SIZE);
            return false;
        }
    ...
    public boolean setIdioMail(String idioMail)
    {
        ...
        if (!validate)
        {
            errMsg = StringUtil.format(LangRes.MESG_CHCK_0002, LangRes.IDIO_COMN_TEXT_IDIOMAIL, ""
                + DB0008.IDIODATA_IDIOMAIL_SIZE);
            return false;
        }
    ...
    public boolean setIdioSign(String idioSign)
    {
        ...
        if (!validate)
        {
            errMsg = StringUtil.format(LangRes.MESG_CHCK_0002, LangRes.IDIO_COMN_TEXT_IDIOSIGN, ""
                + DB0008.IDIODATA_IDIOSIGN_SIZE);
            return false;
        }
    ...
    public boolean setNickName(String nickName)
    {
        ...
        if (!validate)
        {
            errMsg = StringUtil.format(LangRes.MESG_CHCK_0002, LangRes.IDIO_COMN_TEXT_NICKNAME, ""
                + DB0008.IDIODATA_NICKNAME_SIZE);
            return false;
        }
