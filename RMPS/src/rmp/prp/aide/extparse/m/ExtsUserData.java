/*
 * FileName:       ExtsUserData.java
 * CreateDate:     Jul 4, 2007 2:39:08 PM
 * ProjectName:    RMPS
...
public class ExtsUserData extends WUserData
{
    ...
    public boolean setIdioMark(String idioMark)
    {
        ...
        if (!validate)
        {
            errMsg = StringUtil.format(LangRes.MESG_CHCK_0002, LangRes.EXTS_COMN_TEXT_IDIOMARK, ""
                + DB0008.EXTSDATA_IDIOMARK_SIZE);
            return false;
        }
