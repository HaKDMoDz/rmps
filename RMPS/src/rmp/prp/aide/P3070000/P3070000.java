 ...
 * @author Amon
 */
public class P3070000 extends AForm implements IPrpPlus
{
    // ////////////////////////////////////////////////////////////////////////
    // 控制变量区域
    // ////////////////////////////////////////////////////////////////////////
    ...
    public static String getMesg(String mesgId)
    {
        if (langRes == null)
        {
            ...
            try
            {
                FileUtil.readLangRes(langRes, EnvCons.PATH_P3070000, EnvCons.COMN_SOFT_LANG);
            }
            catch (Exception exp)
            {
    ...
    private static String getInfoPath()
    {
        ...
        sb.append(EnvCons.PATH_P3070000).append(EnvCons.COMN_SP_FILE);
    ...
    public static void main(String[] args)
    {
        ...
        soft.wInit();
        soft.showView(VIEW_NORM);

        // 承载窗口引用
        softFForm.setDefaultCloseOperation(FForm.EXIT_ON_CLOSE);
    }
    /** serialVersionUID */
    private static final long serialVersionUID = 6967295295116651542L;
}
