...
/// 运行平台
/// </summary>
public partial class exts_exts0018 : Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        Session[cons.wrp.WrpCons.SCRIPTID] = "exts0018";
        ...
        guidItem = guidList[4];
        guidItem.K = cons.EnvCons.PRE_URL + "/exts/exts0018.aspx";
        guidItem.V1 = "运行平台";
        guidItem.V2 = "运行平台";
        ...
        pf_PlatForm.PlatForm = extsBase.P301000D;
    ...
    protected void bt_NextStep_Click(object sender, EventArgs e)
    {
        ...
        extsBase.P301000D = pf_PlatForm.PlatForm;
        Response.Redirect("~/exts/exts0019.aspx");
    }
