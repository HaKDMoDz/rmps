...
public class QQUser
{
    ...
    {
        md5pwd1 = HashUtil.digest(pwd.getBytes(), "MD5");
        md5pwd2 = HashUtil.digest(md5pwd1, "MD5");
        md5pwd = md5pwd2;
    }
    ...
    /**
     * @param unknown06Token
     *            the unknown06Token to set
     */
    ...
    /**
     * @param unknown07Token
     *            the unknown07Token to set
     */
    ...
    /**
     * @param unknown08Token
     *            the unknown08Token to set
     */
    ...
    {
        return loginInfoUnknow1;
    }

    public void setLoginInfoUnknow1(byte[] loginInfoUnknow1)
    {
        this.loginInfoUnknow1 = loginInfoUnknow1;
    }
    ...
    public void setLoginInfoData(byte[] loginInfoData)
    {
    ...
    {
        return loginInfoMagic;
    }

    public void setLoginInfoMagic(byte[] loginInfoMagic)
    {
        this.loginInfoMagic = loginInfoMagic;
    }

    public byte[] getLoginInfoKey1()
    {
        return loginInfoKey1;
    }

    public void setLoginInfoKey1(byte[] loginInfoKey1)
    {
        this.loginInfoKey1 = loginInfoKey1;
    }

    public byte[] getLoginInfoKey3()
    {
        return loginInfoKey3;
    }

    public void setLoginInfoKey3(byte[] loginInfoKey3)
    {
        this.loginInfoKey3 = loginInfoKey3;
    }

    public byte[] getLoginInfoKey2()
    {
        return loginInfoKey2;
    }

    public void setLoginInfoKey2(byte[] loginInfoKey2)
    {
        this.loginInfoKey2 = loginInfoKey2;
    }

    public byte[] getLoginInfoUnknow2()
    {
        return loginInfoUnknow2;
    }

    public void setLoginInfoUnknow2(byte[] loginInfoUnknow2)
    {
        this.loginInfoUnknow2 = loginInfoUnknow2;
    }

    public byte[] getLoginInfoLarge()
    {
        return loginInfoLarge;
    }

    public void setLoginInfoLarge(byte[] loginInfoLarge)
    {
        this.loginInfoLarge = loginInfoLarge;
    }
