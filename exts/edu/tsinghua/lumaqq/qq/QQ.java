...
public interface QQ {    	
	...
	/** 客户端版本号 - QQ2009 */
	public static final char QQ_CLIENT_VERSION_2009 = 0x190F;
	...
	/** 程序缺省使用的客户端版本号 */
	public static final char QQ_CLIENT_VERSION = QQ_CLIENT_VERSION_2009;
	...
	public static final byte QQ_STATUS_NONE = 0x00;
	public static final byte QQ_STATUS_BUSY = 0x32;
	public static final byte QQ_STATUS_QME = 0x3C;
	public static final byte QQ_STATUS_QUIET = 0x46;
	...
	/** 命令常量 - 登出 */
	public static final char QQ_CMD_LOGOUT = 0x0062; // 0x0001
	/** 命令常量 - 保持在线状态 */
	public static final char QQ_CMD_KEEP_ALIVE = 0x0058;//0x0002
	/** 命令常量 - 修改自己的信息 */
	...
	/** 命令常量 - 发送消息 */
	public static final char QQ_CMD_SEND_IM = 0x00cd; //0x0016
	/** 命令常量 - 接收消息 */
	public static final char QQ_CMD_RECV_IM = 0x0017;
	public static final char QQ_CMD_RECV_IM_09 = 0x00ce;
	/** 命令常量 - 把自己从对方好友名单中删除 */
...
/*------------------------------------09协议增加-------------------------------------*/
	/** 命令常量 - 登陆touch */
	public static final char QQ09_CMD_LOGIN_TOUCH = 0x0091;
	public static final char QQ09_CMD_LOGIN_REQUEST = 0x00ba;
	public static final char QQ09_CMD_LOGIN_VERIFY = 0x00dd;
	public static final char QQ09_CMD_LOGIN_GET_INFO = 0x00e5;
	public static final char QQ09_CMD_LOGIN_SEND_INFO = 0x0030;
	public static final char QQ09_CMD_LOGIN_GET_LIST = 0x0018;
	public static final char QQ09_CMD_LOGIN_A4 = 0x00a4;
	
	public static final byte[] QQ09_LOCALE = {0x00,0x00,0x08,0x04,0x01,(byte)0xE0}; 
	public static final byte[] QQ09_VERSION_SPEC = {0x00,0x00,0x02,0x20,0x00,
		0x00,0x00,0x01,0x00,0x00,0x09,(byte)0xD3}; 
	public static final byte[] QQ09_EXE_HASH = {(byte)0x8C,0x56,(byte)0x8A,(byte)0x9E,(byte)0xCF,(byte)0xFC,
		(byte)0x83,0x21,(byte)0x87,(byte)0x92,0x3B,0x45,0x15,(byte)0xED,0x3B,(byte)0xA4};
	
	public static final byte[] QQ09_ZEROS15={0x00,0x00,0x00,0x00,0x00,0x00,0x00,
		0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00};
/*---------------------------------------------------------------------------------------*/	
	
	/** 命令常量 - 得到好友列表 */
	public static final char QQ_CMD_GET_FRIEND_LIST = 0x0126; //0x0026
	/** 命令常量 - 得到在线好友列表 */
	public static final char QQ_CMD_GET_ONLINE_OP = 0x0027;
	/** 命令常量 - 发送短消息 */
	public static final char QQ_CMD_SEND_SMS = 0x002D;
	/** 命令常量 - 群相关命令 */
	public static final char QQ_CMD_CLUSTER_CMD = 0x0002;
	/** 命令常量 - 测试连接 */
	public static final char QQ_CMD_TEST = 0x0031;
	/** 命令常量 - 分组数组操作 */
	public static final char QQ_CMD_GROUP_DATA_OP = 0x0001; // 04 协议 0x003C
	/** 命令常量 - 上传分组中的好友QQ号列表 */
	...
	/** 群操作命令 - 得到群资料 */
	public static final byte QQ_CLUSTER_CMD_GET_CLUSTER_INFO	= 0x72; //0x04
	/** 群操作命令 - 激活群 */
	...
	/** 群操作命令 - 扩展格式的群消息 */
	public static final byte QQ_CLUSTER_CMD_SEND_IM_EX 			= 0x2A;
	/** 群操作命令 - 设置成员角色 */
	...
	/** 服务器端数据操作 - 下载组名 */
	public static final byte QQ_SUB_CMD_DOWNLOAD_GROUP_NAME = 0x1f;
	...
	/** 服务器端数据操作 - 上传好友备注 */
	public static final byte QQ_SUB_CMD_UPLOAD_FRIEND_REMARK = 0x69;
	/** 服务器端数据操作 - 添加好友到列表中 */
	...
	/** 来自好友的消息 */
	public static final char QQ_RECV_IM_FRIEND = 0x00A6; //0x0009 0801协议
	/** 来自陌生人的消息 */
	public static final char QQ_RECV_IM_STRANGER = 0x0031;
	
	public static final char QQ09_RECV_IM_MOBILE = 0x000A;
	/** 手机短消息 - 普通绑定用户 */
	...
	public static final char QQ_RECV_IM_CLUSTER_09 = 0x0052;
	/** 群通知 */
