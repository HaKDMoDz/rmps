                                                            ...
                                                            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                                                <tr>
                                                                    ...
                                                                    <td style="height: 30px; width:160px;" align="center">
                                                                        <img src="<%=cons.EnvCons.PRE_URL%>/icon/icon0001.ashx?sid=comn,_<%=(ay == cons.SysCons.OS_IDX_ALL) ? "ALL" : "DEF"%>&uri=16" title="平台通用" alt="平台通用" width="16" height="16" />
                                                                        <img src="<%=cons.EnvCons.PRE_URL%>/icon/icon0001.ashx?sid=comn,_<%=((ay & cons.SysCons.OS_IDX_WINDOWS) != 0) ? "WIN" : "DEF"%>&uri=16" title="Windows平台" alt="Windows平台" width="16" height="16" />
                                                                        <img src="<%=cons.EnvCons.PRE_URL%>/icon/icon0001.ashx?sid=comn,_<%=((ay & cons.SysCons.OS_IDX_MACINTOSH) != 0) ? "MAC" : "DEF"%>&uri=16" title="Macintosh平台" alt="Macintosh平台" width="16" height="16" />
                                                                        <img src="<%=cons.EnvCons.PRE_URL%>/icon/icon0001.ashx?sid=comn,_<%=((ay & cons.SysCons.OS_IDX_LINUX) != 0) ? "LNX" : "DEF"%>&uri=16" title="Linux平台" alt="Linux平台" width="16" height="16" />
                                                                        <img src="<%=cons.EnvCons.PRE_URL%>/icon/icon0001.ashx?sid=comn,_<%=((ay & cons.SysCons.OS_IDX_UNIX) != 0) ? "UNX" : "DEF"%>&uri=16" title="Unix平台" alt="Unix平台" width="16" height="16" />
                                                                        <img src="<%=cons.EnvCons.PRE_URL%>/icon/icon0001.ashx?sid=comn,_<%=((ay & cons.SysCons.OS_IDX_MOBILE) != 0) ? "MBL" : "DEF"%>&uri=16" title="移动平台" alt="移动平台" width="16" height="16" />
                                                                        <img src="<%=cons.EnvCons.PRE_URL%>/icon/icon0001.ashx?sid=comn,_<%=((ay & cons.SysCons.OS_IDX_UNKNOWN) != 0) ? "SPC" : "DEF"%>&uri=16" title="其它平台" alt="其它平台" width="16" height="16" />
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                            <div style="text-align:right">
