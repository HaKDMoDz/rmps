<%@ Page Language="C#" MasterPageFile="~/tool/tool.master" AutoEventWireup="true" CodeFile="tool1311.aspx.cs" Inherits="tool_tool1311" %>

<asp:Content ID="AmonData" ContentPlaceHolderID="AmonView" runat="Server">
    <table border="0" cellpadding="0" cellspacing="0" id="TB_DATA">
        <tr>
            <td align="center">
                <div style="position: relative; width: 460px; height: 120px; overflow: scroll; border: solid 1px #CCCCCC;">
                    <table border="0" cellpadding="2" cellspacing="0" style="min-width: 100%; width: 100%;">
                        <tr>
