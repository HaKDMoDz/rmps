...
namespace com.magickms.api.User32
{
    public class User32API
    {
        ...
        /// <returns></returns>
        [DllImport("User32.dll")]
        public static extern uint GetWindowThreadProcessId(IntPtr handel, ref int processId);
        ...
        /// <returns></returns>
        [DllImport("user32.dll")]
        public static extern int SendMessage(IntPtr hWnd, WindowMessage wMsg, int wParam, int lParam);
        [DllImport("user32.dll")]
        ...
        [DllImport("user32.dll", EntryPoint = "SendMessageA")]
        public static extern int SendMessageA(IntPtr hwnd, WindowMessage wMsg, int wParam, string lParam);
        [DllImport("user32.dll", EntryPoint = "SendMessageA")]
        public static extern int SendMessageA(IntPtr hwnd, WindowMessage wMsg, int wParam, int lParam);
        [DllImport("user32.dll")]
