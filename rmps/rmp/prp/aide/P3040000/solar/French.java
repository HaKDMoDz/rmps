...
public class French extends SolarDate
{
    ...
    public String format()
    {
        if (super.month == 13)
            ...
            return MessageFormat.format("Decade {0}, {1} de {2} de l''Annee {3,number,#} de la Revolution", new Object[]
            { decadeNames[(int) ProtoDate.quotient(super.day - 1, 10D)], ProtoDate.nameFromNumber(super.day, dayOfWeekNames), ProtoDate.nameFromMonth(super.month, monthNames), new Long(super.year) });
    }
    ...
    public static final Location PARIS = new Location("Paris, France", ProtoDate.angle(48D, 50D, 11D), ProtoDate.angle(2D, 20D, 15D), ProtoDate.mt(27D), 1.0D);
    public static final String monthNames[] =
    { "Vendemiaire", "Brumaire", "Frimaire", "Nivose", "Pluviose", "Ventose", "Germinal", "Floreal", "Prairial", "Messidor", "Thermidor", "Fructidor", "Sansculottides" };
