...
import rmp.prp.Prps;
import rmp.prp.aide.P3070000.v.MainPanel;
import rmp.prp.aide.P3070000.v.MiniPanel;
import rmp.prp.aide.P3070000.v.NormPanel;
import rmp.prp.aide.P3070000.v.TailPanel;
...
import cons.prp.aide.P3070000.ConstUI;
 ...
 * @author Amon
 */
public class P3070000 extends WForm implements IPrpPlus
{
    // ////////////////////////////////////////////////////////////////////////
    // 控制变量区域
    // ////////////////////////////////////////////////////////////////////////
    ...
    public void wShowHelp()
    {
        ...
        {
            Logger.getLogger(P3070000.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    {
        C1010000.setInfo(EnvUtil.getLangPath(EnvCons.COMN_SOFT_INFO, PrpCons.P3070000_S, baseFolder));
    ...
    public static String getMesg(String mesgId)
    {
        if (langRes == null)
        {
            ...
            try
            {
                FileUtil.readLangRes(langRes, EnvUtil.getLangPath(EnvCons.COMN_SOFT_LANG, PrpCons.P3070000_S, baseFolder));
            }
            catch (Exception exp)
            {
