<%@ Page Language="C#" AutoEventWireup="true" CodeFile="user0201.aspx.cs" Inherits="user_user0201" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>
        <%=cons.wrp.WrpCons.TITLE_USER%>
    </title>
    <%=cons.wrp.WrpCons.KEYWORDS_USER%>
    <%=cons.wrp.WrpCons.DESCRIPTION_USER%>
    <%=rmp.wrp.Wrps.ComnHead(cons.wrp.WrpCons.MODULE_USER)%>
</head>
<body>
                ...
                <table border="0" cellpadding="4" cellspacing="0" width="300">
                    <tr>
                        <td align="right" style="height: 40px;">
                            ...
                            <asp:HiddenField ID="hd_Return" runat="server" />
                        </td>
                    </tr>
                </table>
            </td>
...
<%= rmp.wrp.Wrps.ComnScript(Session, cons.wrp.WrpCons.MODULE_USER) %>
