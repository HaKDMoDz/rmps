...
{
    public class ToolbarVisibleAction : WPwdAction
    {
        public override void Add(ToolStripItem item, IViewModel viewModel)
        {
            ...
            {
                (item as ToolStripMenuItem).Checked = model.ToolBarVisible;
                return;
            }
            if (item is ToolStripButton)
            {
                (item as ToolStripButton).Checked = model.ToolBarVisible;
                return;
            }
        }
