 namespace Me.Amon
{
    public class EApp
    {
        ...
        public const string FILE_IMG = "图片文件（*.png,*.jpg,*.bmp）|*.png;*.jpg;*.jpeg;*.jpe;*.jfif;*.bmp;*.dib;*.rle|PNG文件（*.png）|*.png|JPG文件（*.jpg,*.jpeg,*.jpe,*.jfif）|*.jpg;*.jpeg;*.jpe;*.jfif|BMP文件（*.bmp,*dib,*.rle）|*.bmp;*.dib;*.rle";
        ...
        public const string FILE_OPEN_IMG_ICO = "图片文件（*.png,*.jpg,*.bmp,*.ico）|*.png;*.jpg;*.jpeg;*.jpe;*.jfif;*.bmp;*.dib;*.rle;*.gif|PNG文件（*.png）|*.png|JPG文件（*.jpg,*.jpeg,*.jpe,*.jfif）|*.jpg;*.jpeg;*.jpe;*.jfif|BMP文件（*.bmp,*dib,*.rle）|*.bmp;*.dib;*.rle|ICO文件（*.ico）|*.ico";
        public const string FILE_OPEN_RES = "ICO文件（*.ico）|*.ico|ICL文件（*.icl）|*.icl|DLL文件（*.dll）|*.dll|EXE文件（*.exe）|*.exe|OCX文件（*.ocx）|*.ocx|CPL文件（*.cpl）|*.cpl|SRC文件（*.src）|*.src";
