        ...
        private void DbInit()
        {
            using (SQLiteTransaction mytransaction = _Connection.BeginTransaction())
            {
                using (SQLiteCommand mycommand = new SQLiteCommand(_Connection))
                {
                    ...
                    sql.Clear();
                    sql.Append("CREATE TABLE ").Append(DBConst.AUCS0100).Append("(");
                    sql.Append(DBConst.AUCS0101).Append(" INT,");
                    sql.Append(DBConst.AUCS0102).Append(" VARCHAR(").Append(DBConst.AUCS0102_SIZE).Append("),");
                    sql.Append(DBConst.AUCS0103).Append(" VARCHAR(").Append(DBConst.AUCS0103_SIZE).Append("),");
                    sql.Append(DBConst.AUCS0104).Append(" VARCHAR(").Append(DBConst.AUCS0104_SIZE).Append("),");
                    sql.Append(DBConst.AUCS0105).Append(" VARCHAR(").Append(DBConst.AUCS0105_SIZE).Append("),");
                    sql.Append(DBConst.AUCS0106).Append(" VARCHAR(").Append(DBConst.AUCS0106_SIZE).Append("),");
                    sql.Append(DBConst.AUCS0107).Append(" VARCHAR(").Append(DBConst.AUCS0107_SIZE).Append("),");
                    sql.Append(DBConst.AUCS0108).Append(" DATETIME,");
                    sql.Append(DBConst.AUCS0109).Append(" DATETIME,");
                    sql.Append(DBConst.AUCS010A).Append(" INT,");
                    sql.Append(DBConst.AUCS010B).Append(" INT,");
                    sql.Append("PRIMARY KEY (").Append(DBConst.AUCS0103).Append(")");
                    sql.Append(")");
                    mycommand.CommandText = sql.ToString();
                    Logs.Info(mycommand.CommandText);
                    mycommand.ExecuteNonQuery();
