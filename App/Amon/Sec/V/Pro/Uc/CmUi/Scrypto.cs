...
namespace Me.Amon.Sec.V.Pro.Uc.CmUi
{
    public class Scrypto : ACm
    {
        ...
        public override void InitOpt()
        {
            ...
            _Cm.CbName.Items.Add(new Items { K = ESec.SCRYPTO_AES, V = "Aes" });//0 .. 256
            _Cm.CbName.Items.Add(new Items { K = ESec.SCRYPTO_AESFAST, V = "AesFast" });
            _Cm.CbName.Items.Add(new Items { K = ESec.SCRYPTO_AESLIGHT, V = "AesLight" });
            _Cm.CbName.Items.Add(new Items { K = ESec.SCRYPTO_BLOWFISH, V = "Blowfish" });//0 .. 448
            _Cm.CbName.Items.Add(new Items { K = ESec.SCRYPTO_CAMELLIA, V = "Camellia" });//128, 192, 256
            _Cm.CbName.Items.Add(new Items { K = ESec.SCRYPTO_CAMELLIALIGHT, V = "CamelliaLight" });
            _Cm.CbName.Items.Add(new Items { K = ESec.SCRYPTO_CAST5, V = "Cast5" });//0 .. 128
            _Cm.CbName.Items.Add(new Items { K = ESec.SCRYPTO_CAST6, V = "Cast6" });//0 .. 256
            _Cm.CbName.Items.Add(new Items { K = ESec.SCRYPTO_DES, V = "Des" });//64
            _Cm.CbName.Items.Add(new Items { K = ESec.SCRYPTO_DESEDE, V = "DesEde" });//128, 192
            _Cm.CbName.Items.Add(new Items { K = ESec.SCRYPTO_GOST28147, V = "Gost28147" });//256
            _Cm.CbName.Items.Add(new Items { K = ESec.SCRYPTO_NOEKEON, V = "Noekeon" });//128
            _Cm.CbName.Items.Add(new Items { K = ESec.SCRYPTO_NULL, V = "Null" });
            _Cm.CbName.Items.Add(new Items { K = ESec.SCRYPTO_RC2, V = "RC2" });//0 .. 1024
            _Cm.CbName.Items.Add(new Items { K = ESec.SCRYPTO_RC532, V = "RC5" });//0 .. 128
            //_Cm.CbName.Items.Add(new Item { K = IData.SCRYPTO_RC564, V = "RC5（64位）" });//0 .. 128
            _Cm.CbName.Items.Add(new Items { K = ESec.SCRYPTO_RC6, V = "RC6" });//0 .. 256
            _Cm.CbName.Items.Add(new Items { K = ESec.SCRYPTO_RIJNDAEL, V = "Rijndael" });//0 .. 256
            _Cm.CbName.Items.Add(new Items { K = ESec.SCRYPTO_SEED, V = "Seed" });//128
            _Cm.CbName.Items.Add(new Items { K = ESec.SCRYPTO_SERPENT, V = "Serpent" });//128, 192, 256
            _Cm.CbName.Items.Add(new Items { K = ESec.SCRYPTO_SKIPJACK, V = "Skipjack" });//0 .. 128
            _Cm.CbName.Items.Add(new Items { K = ESec.SCRYPTO_TEA, V = "Tea" });//128
            _Cm.CbName.Items.Add(new Items { K = ESec.SCRYPTO_TWOFISH, V = "Twofish" });//128, 192, 256
            _Cm.CbName.Items.Add(new Items { K = ESec.SCRYPTO_XTEA, V = "Xtea" });//128
            _Cm.CbName.Enabled = false;

            BeanUtil.Clear(_Cm.CbMode);
            _Cm.CbMode.Items.Add(new Items { K = "CBC", V = "CBC" });
            _Cm.CbMode.Items.Add(new Items { K = "CCM", V = "CCM" });
            _Cm.CbMode.Items.Add(new Items { K = "CFB", V = "CFB" });
            _Cm.CbMode.Items.Add(new Items { K = "EAX", V = "EAX" });
            _Cm.CbMode.Items.Add(new Items { K = "ECB", V = "ECB" });
            _Cm.CbMode.Items.Add(new Items { K = "GCM", V = "GCM" });
            //_Cm.CbMode.Items.Add(new Item { K = "GOFB", V = "GOFB" });
            _Cm.CbMode.Items.Add(new Items { K = "OFB", V = "OFB" });
            _Cm.CbMode.Items.Add(new Items { K = "CTS", V = "CTS" });
            _Cm.CbMode.Items.Add(new Items { K = "OpenPgpCFB", V = "OpenPgpCFB" });
            ...
            _Cm.CbPads.Items.Add(new Items { K = "ISO10126d2", V = "ISO10126d2" });
            _Cm.CbPads.Items.Add(new Items { K = "ISO7816d4", V = "ISO7816d4" });
            _Cm.CbPads.Items.Add(new Items { K = "Pkcs7", V = "Pkcs7" });
            _Cm.CbPads.Items.Add(new Items { K = "Tbc", V = "Tbc" });
            _Cm.CbPads.Items.Add(new Items { K = "X923", V = "X923" });
            _Cm.CbPads.Items.Add(new Items { K = "ZeroByte", V = "ZeroByte" });
