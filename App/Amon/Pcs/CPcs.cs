namespace Me.Amon.Pcs
{
    public class CPcs
    {
        ...
        public const string ICON_LIB = "_lib";
        public const string PATH_LIB_DOCUMENTS = ":documents";
        public const string ICON_LIB_DOCUMENTS = "_documents";
        public const string PATH_LIB_PICTURES = ":pictures";
        public const string ICON_LIB_PICTURES = "_pictures";
        public const string PATH_LIB_AUDIOS = ":audios";
        public const string ICON_LIB_AUDIOS = "_audios";
        public const string PATH_LIB_VIDEOS = ":videos";
        public const string ICON_LIB_VIDEOS = "_videos";
        public const string PATH_ALL = "*all";
        public const string ICON_ALL = "_all";
        public const string PATH_SNS = "*sns";
        public const string ICON_SNS = "_sns";
        public const string PATH_APP = "*app";
        public const string ICON_APP = "_app";
        public const string PATH_BIN = "*bin";
        public const string ICON_BIN = "_bin";
