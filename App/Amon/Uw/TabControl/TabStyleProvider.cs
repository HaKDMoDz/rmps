...
namespace System.Windows.Forms
{
    ...
    public abstract class TabStyleProvider : Component
    {
        ...
        protected TabStyleProvider(ATabControl tabControl)
        {
        ...
        public static TabStyleProvider CreateProvider(ATabControl tabControl)
        {
            ...
            switch (tabControl.DisplayStyle)
            {
                ...
                case TabStyle.Amon:
                    provider = new TabStyleAmonProvider(tabControl);
                    break;
        ...
        protected ATabControl _TabControl;
