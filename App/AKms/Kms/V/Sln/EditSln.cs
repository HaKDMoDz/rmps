...
namespace Me.Amon.Kms.V.Sln
{
    public partial class EditSln : Form
    {
        ...
        private void InitData()
        {
            ...
            CbTarget.Items.Add(new ListModel<ETarget>(ETarget.App, "程序"));
            CbTarget.Items.Add(new ListModel<ETarget>(ETarget.Scb, "剪贴板"));
            CbTarget.Items.Add(new ListModel<ETarget>(ETarget.Img, "文件系统"));
            ...
            CbMethod.Items.Add(new ListModel<EMethod>(EMethod.None, "请选择"));
            CbMethod.Items.Add(new ListModel<EMethod>(EMethod.Answer, "应答式交互"));
            CbMethod.Items.Add(new ListModel<EMethod>(EMethod.Active, "手控式交互"));
            CbMethod.Items.Add(new ListModel<EMethod>(EMethod.Attack, "攻击式交互"));
        ...
        private void ShowData()
        {
            ...
            // 响应方式
            CbTarget.SelectedItem = new ListModel<ETarget>(_curSln.Target, "");
            CbMethod.SelectedItem = new ListModel<EMethod>(_curSln.Method, "");
            CbOutput.SelectedItem = new ListModel<EOutput>(_curSln.Output, "");
        ...
        private void SaveData()
        {
            ...
            // 会话目标
            var target = CbTarget.SelectedItem as ListModel<ETarget>;
            ...
            // 会话模式
            var method = CbMethod.SelectedItem as ListModel<EMethod>;
            ...
            {
                var output = CbOutput.SelectedItem as ListModel<EOutput>;
