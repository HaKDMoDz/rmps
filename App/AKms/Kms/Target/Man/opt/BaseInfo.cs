...
namespace Me.Amon.Kms.Target.Man
{
    public partial class BaseInfo : UserControl, IOptions
    {
        ...
        public void Init()
        {
            ...
            CbStyle.Items.Add(new ListItem<EStyle>(EStyle.Elegant, "高雅"));
            CbStyle.Items.Add(new ListItem<EStyle>(EStyle.Humors, "幽默"));
            CbStyle.Items.Add(new ListItem<EStyle>(EStyle.Normal, "默认"));
            CbStyle.Items.Add(new ListItem<EStyle>(EStyle.Vulgar, "低俗"));
            CbStyle.Items.Add(new ListItem<EStyle>(EStyle.Revile, "脏话"));
        ...
        private void CbStyle_SelectedIndexChanged(object sender, System.EventArgs e)
        {
            ...
            ListItem<EStyle> item = CbStyle.SelectedItem as ListItem<EStyle>;
            if (item == null)
            {
                return;
            }
