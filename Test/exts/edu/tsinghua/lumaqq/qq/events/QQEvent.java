...
public class QQEvent extends EventObject {
	 ...
	 * UploadGroupFriendReplyPacket，不过没有什么可用信息，通知事件而已
	 */
	...
	public static final int FRIEND_ADD_NEED_ANSWER = 0x3026;
	
	public static final int FRIEND_ADD_NO_AUTH = 0x3027;
	 ...
	 * GetLoginTokenReplyPacket 或者 LoginRequestReplyPacket
	 */
	...
	//增加2009新事件
	public static final int LOGIN_TOUCH_OK = 0x5007;
	
	public static final int LOGIN_REQUEST_OK = 0x5008;
	
	public static final int LOGIN_VERIFY_OK = 0x5009;
	
	public static final int LOGIN_GET_INFO_OK = 0x50a0;
	
	public static final int LOGIN_GET_LIST_OK = 0x50a1;
