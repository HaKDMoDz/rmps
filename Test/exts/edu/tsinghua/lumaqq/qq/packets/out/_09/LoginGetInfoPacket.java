...
public class LoginGetInfoPacket extends BasicOutPacket {
     ...
     * 构造函数
     */
    public LoginGetInfoPacket(QQUser user) {
        super(QQ.QQ09_CMD_LOGIN_GET_INFO, true, user);
    }
     ...
     */
    public LoginGetInfoPacket(ByteBuffer buf, int length, QQUser user) throws PacketParseException {
    ...
    protected void putBody(ByteBuffer buf) {
		buf.putChar((char)0x010D );	//length or sth..
		buf.put((byte) 0x00 );
		buf.putChar((char)0x0101 );
		...
		buf.put( user.getLoginInfoUnknow1() );
		buf.putInt( user.getServerTime() );
		buf.putChar((char) user.getLoginInfoData().length );
		buf.put( user.getLoginInfoData() );
