...
import rmp.prp.aide.P3030000.v.TailPanel;
 ...
 * @author Amon
 */
public class P3030000 extends WForm implements IPrpPlus
{
    // ////////////////////////////////////////////////////////////////////////
    // 控制变量区域
    // ////////////////////////////////////////////////////////////////////////
    ...
    public void wShowHelp()
    {
        ...
        {
            Logger.getLogger(P3030000.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    {
        C1010000.setInfo(EnvUtil.getLangPath(EnvCons.COMN_SOFT_INFO, PrpCons.P3030000_S, baseFolder));
    ...
    public static String getMesg(String mesgId)
    {
        if (langRes == null)
        {
            ...
            try
            {
                FileUtil.readLangRes(langRes, EnvUtil.getLangPath(EnvCons.COMN_SOFT_LANG, PrpCons.P3030000_S, baseFolder));
            }
            catch (Exception exp)
            {
