...
import rmp.prp.Prps;
import rmp.prp.aide.P30A0000.v.MainPanel;
import rmp.prp.aide.P30A0000.v.MiniPanel;
import rmp.prp.aide.P30A0000.v.NormPanel;
import rmp.prp.aide.P30A0000.v.TailPanel;
 ...
 * @author Amon
 */
public class P30A0000 extends WForm implements IPrpPlus
{
    // ////////////////////////////////////////////////////////////////////////
    // 控制变量区域
    // ////////////////////////////////////////////////////////////////////////
    ...
    public void wShowHelp()
    {
        ...
        {
            Logger.getLogger(P30A0000.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    {
        C1010000.setInfo(EnvUtil.getLangPath(EnvCons.COMN_SOFT_INFO, PrpCons.P30A0000_S, baseFolder));
    ...
    public static String getMesg(String mesgId)
    {
        if (langRes == null)
        {
            ...
            try
            {
                FileUtil.readLangRes(langRes, EnvUtil.getLangPath(EnvCons.COMN_SOFT_LANG, PrpCons.P30A0000_S, baseFolder));
            }
            catch (Exception exp)
            {
