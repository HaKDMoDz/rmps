<%@ Page Language="C#" AutoEventWireup="true" CodeFile="icon0102.aspx.cs" Inherits="icon_icon0102" %>
...
<body>
    <form id="AmonForm" runat="server">
        <table border="0" cellpadding="0" cellspacing="0" width="100%">
            <tr>
                <th align="center" style="height: 30px;" class="TD_DataHead_TL_L">
                    文件(F)：
                    ...
                    <table width="96%" border="0" cellpadding="2" cellspacing="0" class="TB_DataList_TL">
                        <tr>
                            ...
                            <td class="TD_DataItem_TL_L">
                                <embed src="<%= DIR_PATH + t %>" width="48" height="48" pluginspage="http://www.adobe.com/svg/viewer/install/" type="image/svg+xml" />
                                <%
...
<script type="text/javascript" src="icon0102.js"></script>