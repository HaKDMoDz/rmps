<%@ Page Language="C#" MasterPageFile="~/math/math.master" AutoEventWireup="true" CodeFile="math0001.aspx.cs" Inherits="math_math0001" %>
...
<asp:Content ID="AmonData" ContentPlaceHolderID="AmonView" runat="Server">
    <table border="0" cellpadding="0" cellspacing="0" id="TB_DATA">
        ...
        <tr>
            <td>
                <table border="0" cellpadding="0" cellspacing="0" width="100%" id="tb_MainMath">
                    <tr class="TH_MATH">
                    ...
                    <tr class="TH_MATH">
                        <td align="center">
                            <asp:TextBox ID="ta_MathExps" runat="server" Rows="5" TextMode="MultiLine" Width="440"></asp:TextBox>
            ...
            <tr>
                <td align="center">
                    <table width="100%" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                            <td align="center" style="height: 20px;" onmousedown="iNetHelper.dragForm(event, 'dv_MathExps');" onmouseup="iNetHelper.dropForm(event, 'dv_MathExps');">
                                运算过程
                            </td>
