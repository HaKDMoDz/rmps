<%@ Page Language="C#" MasterPageFile="~/link/link.master" AutoEventWireup="true" CodeFile="link0103.aspx.cs" Inherits="link_link0103" %>
                ...
                <table width="460" border="0" cellpadding="3" cellspacing="0" class="TB_DataList_TL">
                    ...
                    <tr>
                        ...
                        <td style="width: 80%;" class="TD_DataItem_TL_L" align="left">
                            ...
                            <asp:ImageButton ID="im_P3070109" runat="server" ImageUrl="~/_images/srch.png" ImageAlign="middle" ToolTip="自动查找网站LOGO" Width="16" Height="16" OnClick="im_P3070109_Click" OnClientClick="return checkLink();" />
                        </td>
                    </tr>
                    <tr>
                        <td style="width: 20%;" class="TD_DataHead_TL_L" align="center">
                        ...
                        <td style="width: 80%;" class="TD_DataItem_TL_L" align="left">
                            ...
                            <asp:FileUpload ID="fu_P3070106" runat="server" />
                            <asp:Button ID="bt_P3070106" runat="server" Text="上传(U)" AccessKey="U" OnClick="bt_P3070106_Click" />
