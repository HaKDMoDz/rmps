<%@ Page Language="C#" MasterPageFile="~/exts/exts.master" AutoEventWireup="true" CodeFile="exts0304.aspx.cs" Inherits="exts_exts0304" %>
    ...
    <table border="0" cellpadding="0" cellspacing="0" id="TB_DATA">
        ...
        <tr>
            <td align="center" style="height: 40px;">
                <asp:Label ID="lb_NoteInfo" runat="server" Text="确认要删除此文件信息么？此操作将不可恢复！"></asp:Label>
            </td>
        </tr>
        <tr>
            <td align="center">
