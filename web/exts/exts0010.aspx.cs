...
public partial class exts_exts0010 : Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        Session[cons.wrp.WrpCons.SCRIPTID] = "exts0010";
        ...
        hl_QModel.NavigateUrl = "~/exts/exts0020.aspx" + sid;
    }
    ...
    protected void bt_NextStep_Click(object sender, EventArgs e)
    {
        ...
        extsBase.P301000F = UserInfo.Current(Session).UserHash;
        ...
        Response.Redirect("~/exts/exts0011.aspx");
    }
}