<%@ Page Language="C#" MasterPageFile="~/iask/iask.master" AutoEventWireup="true" CodeFile="iask1303.aspx.cs" Inherits="iask_iask1303" %>

<asp:Content ID="AmonData" ContentPlaceHolderID="AmonView" runat="Server">
    <table border="0" cellpadding="0" cellspacing="0" id="TB_DATA">
        <tr>
            <td align="right">
                <a onclick="return openWnd('/tool/tool1303.aspx', 500, 400)" href="#">独立启动</a>
            </td>
        </tr>
        <tr>
            <td>
