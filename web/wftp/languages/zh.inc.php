...
$net2ftp_messages["Logging into the FTP server"] = "正在登录到FTP服务器";
$net2ftp_messages["Setting the passive mode"] = "正在设置登录模式";
$net2ftp_messages["Getting the FTP system type"] = "正在获取FTP服务类型";
$net2ftp_messages["Changing the directory"] = "正在切换目录";
$net2ftp_messages["Getting the current directory"] = "正在获取当前目录";
...
$net2ftp_messages["Reading the file"] = "文件读取中……";
$net2ftp_messages["Parsing the file"] = "文件转换中……";
...
$net2ftp_messages["Unable to switch to the passive mode on FTP server <b>%1\$s</b>."] = "无法在FTP服务器上转到被动模式 <b>%1\$s</b>.";
...
$net2ftp_messages["Unable to switch to the passive mode on the second (target) FTP server <b>%1\$s</b>."] = "无法转到被动模式，在第二台 (target) FTP 服务器 <b>%1\$s</b>.";
...
$net2ftp_messages["Symlink"] = "符号连接";
$net2ftp_messages["ASP script"] = "ASP脚本";
$net2ftp_messages["Cascading Style Sheet"] = "级联样式表";
$net2ftp_messages["HTML file"] = "HTML file";
$net2ftp_messages["Java source file"] = "Java源代码文件";
$net2ftp_messages["JavaScript file"] = "JavaScript文件";
$net2ftp_messages["PHP Source"] = "PHP源代码";
$net2ftp_messages["PHP script"] = "PHP脚本";
$net2ftp_messages["Text file"] = "Text文件";
$net2ftp_messages["Bitmap file"] = "Bitmap文件";
$net2ftp_messages["GIF file"] = "GIF文件";
$net2ftp_messages["JPEG file"] = "JPEG文件";
$net2ftp_messages["PNG file"] = "PNG文件";
$net2ftp_messages["TIF file"] = "TIF文件";
$net2ftp_messages["GIMP file"] = "GIMP文件";
$net2ftp_messages["Executable"] = "可执行文件";
$net2ftp_messages["Shell script"] = "Shell脚本";
...
$net2ftp_messages["Setting the passive mode: "] = "设置被动模式：";
...
$net2ftp_messages["Once you are logged in, you will be able to:"] = "登录后，您可以进行如下的操作：";
$net2ftp_messages["Navigate the FTP server"] = "FTP服务器导航";
...
$net2ftp_messages["Download files"] = "下载文件";
...
$net2ftp_messages["Zip files"] = "压缩文件";
...
$net2ftp_messages["Copy, move and delete"] = "复制、移动及删除";
...
$net2ftp_messages["Rename and chmod"] = "重命名及权限调整";
$net2ftp_messages["Chmod handles directories recursively."] = "Chmod handles directories recursively.";
$net2ftp_messages["View code with syntax highlighting"] = "高亮格式代码查看";
$net2ftp_messages["PHP functions are linked to the documentation on php.net."] = "PHP函数以高亮方式连接到php.net网站的对应文档。";
$net2ftp_messages["Plain text editor"] = "文本编辑";
$net2ftp_messages["Edit text right from your browser; every time you save the changes the new file is transferred to the FTP server."] = "基于浏览器的文件编辑，所有的操作都可以随时反映到您的FTP服务器上。";
$net2ftp_messages["HTML editors"] = "网页编辑";
$net2ftp_messages["Edit HTML a What-You-See-Is-What-You-Get (WYSIWYG) form; there are 2 different editors to choose from."] = "可以使用2个不同的编辑器以所见即所得的方式编辑HTML文件。";
$net2ftp_messages["Code editor"] = "代码编辑";
$net2ftp_messages["Edit HTML and PHP in an editor with syntax highlighting."] = "以语法高亮的格式编辑HTML及PHP文件。";
$net2ftp_messages["Search for words or phrases"] = "字词及短语搜索";
$net2ftp_messages["Filter out files based on the filename, last modification time and filesize."] = "按照文件名称、更新日期及文件大小过滤。";
$net2ftp_messages["Calculate size"] = "计算空间大小";
$net2ftp_messages["Calculate the size of directories and files."] = "计算文件及目录的空间大小信息。";

$net2ftp_messages["FTP server"] = "FTP 服务器";
$net2ftp_messages["Example"] = "示例";
$net2ftp_messages["Port"] = "端口";
$net2ftp_messages["Username"] = "用户";
$net2ftp_messages["Password"] = "密码";
...
$net2ftp_messages["Automatic"] = "自动选择";
$net2ftp_messages["Login"] = "登入";
$net2ftp_messages["Clear cookies"] = "清除cookies";
$net2ftp_messages["Admin"] = "Admin";
$net2ftp_messages["Please enter an FTP server."] = "请输入FTP服务器地址！";
$net2ftp_messages["Please enter a username."] = "请输入FTP登录用户！";
$net2ftp_messages["Please enter a password."] = "请输入FTP登录密码！";
