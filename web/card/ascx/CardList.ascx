<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CardList.ascx.cs" Inherits="card_ascx_CardList" %>
            ...
            <table border="0" cellpadding="2" cellspacing="0" class="TB_LIST_ITEM">
                ...
                <tr>
                    <td align="left" class="TD_LIST_BODY">
                        ·&nbsp;<a href="/card/index.aspx">Amon卡片</a>
                    </td>
                </tr>
                <tr>
                    <td align="left" class="TD_LIST_BODY">
                        ·&nbsp;<a href="/card/card0001.aspx">获取代码</a>
                    </td>
                </tr>
                <%
                ...
                <tr>
                    <td align="left" class="TD_LIST_BODY">
                        ·&nbsp;<a href="/card/card0002.aspx">创建卡片</a>
                    </td>
                </tr>
                <%
                    }
