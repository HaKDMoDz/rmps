...
public partial class myim_myim2001 : Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        // Master Page初始化
        Session[cons.wrp.WrpCons.GUIDINDX] = 2;
        Session[cons.wrp.WrpCons.GUIDNAME] = "腾讯QQ";
        Session[cons.wrp.WrpCons.SCRIPTID] = "myim2001";
        ...
        guidItem = guidList[2];
        guidItem.K = cons.EnvCons.PRE_URL + "/myim/myim2001.aspx";
        guidItem.V1 = "腾讯QQ";
        guidItem.V2 = "腾讯QQ";
