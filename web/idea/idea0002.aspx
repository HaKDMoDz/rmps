<%@ Page Language="C#" MasterPageFile="~/idea/idea.master" AutoEventWireup="true" CodeFile="idea0002.aspx.cs" Inherits="idea_idea0002" %>

<asp:Content ID="AmonData" ContentPlaceHolderID="AmonView" runat="Server">
    <table border="0" cellpadding="0" cellspacing="0" id="TB_DATA">
        <tr>
            <td align="right">
                <asp:HiddenField ID="hd_IdeaHash" runat="server" />共有&nbsp;<asp:Label ID="LB_IdeaSize" runat="server" CssClass="TEXT_NOTE1"></asp:Label>&nbsp;条数据&nbsp;当前第&nbsp;<asp:Label ID="LB_PageIndx" runat="server" CssClass="TEXT_NOTE1"></asp:Label>/<asp:Label ID="LB_PageSize" runat="server" CssClass="TEXT_NOTE1"></asp:Label>&nbsp;页&nbsp;<asp:LinkButton ID="LB_LastPage" runat="server" OnClick="LastPage_Click" Enabled="false">上一页</asp:LinkButton>&nbsp;<asp:LinkButton ID="LB_NextPage" runat="server" OnClick="NextPage_Click">下一页</asp:LinkButton>
            </td>
        </tr>
