<%@ Control Language="C#" AutoEventWireup="true" CodeFile="InfoList.ascx.cs" Inherits="info_ascx_InfoList" %>
            ...
            <table border="0" cellpadding="2" cellspacing="0" class="TB_LIST_ITEM">
                ...
                <tr>
                    <td align="left" class="TD_LIST_BODY">
                        ·<a href="/info/index.aspx">关于作者</a>
                    </td>
                </tr>
                <tr>
                    <td align="left" class="TD_LIST_BODY">
                        ·<a href="/info/info0001.aspx">联系作者</a>
                    </td>
                </tr>
                <tr>
                    <td align="left" class="TD_LIST_BODY">
                        ·<a href="/info/info0002.aspx">交换链接</a>
                    </td>
                </tr>
                <tr>
    ...
    <tr>
        <td align="center">
            <table border="0" cellpadding="2" cellspacing="0" class="TB_LIST_ITEM">
                ...
                <tr>
                    <td align="left" class="TD_LIST_BODY">
                        ·<a href="/soft/soft0001.aspx?sid=<%= kvItem.K %>"><%= kvItem.V1 %></a>
                    </td>
                </tr>
                <%
                    }
