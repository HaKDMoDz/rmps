...
public class Persian extends SolarDate
{
    ...
    public static long newYearOnOrBefore(long l)
    {
        ...
        long l1;
        for (l1 = (long)Math.floor(d) - 1L; ProtoDate.solarLongitude(middayInTehran(l1)) > ConstUI.SPRING
            + ProtoDate.deg(2D); l1++)
            ;
        return l1;
    }
    ...
    public static final Location TEHRAN           = new Location("Tehran, Iran", ProtoDate.deg(35.68D), ProtoDate
                                                      .deg(51.420000000000002D), ProtoDate.mt(1100D), 3.5D);
    public static final String   dayOfWeekNames[] = {"Yek-shanbeh", "Do-shanbeh", "Se-shanbeh", "Char-shanbeh",
        "Panj-shanbeh", "Jom`eh", "Shanbeh"       };
    public static final String   monthNames[]     = {"Farvardin", "Ordibehesht", "Xordad", "Tir", "Mordad",
