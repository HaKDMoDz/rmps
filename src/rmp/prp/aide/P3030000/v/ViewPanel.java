 ...
 * <br />
 * 快捷数据浏览面板<br />
 * 此面板默认仅供TailPanel使用，在其它情况下，若存在MiniPanel、NormPanel、MainPanel<br />
 * 等其它可以复用的情况下，也可以以复用窗口的形式出现。<br />
 * <li>使用说明：</li>
 * <br />
 * </ul>
 * @author Amon
...
public class ViewPanel extends javax.swing.JPanel
{
    ...
    /** serialVersionUID */
    private static final long serialVersionUID = -5121524148251204664L;
}
