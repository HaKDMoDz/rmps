<%@ Page Title="" Language="C#" MasterPageFile="~/Amon.master" AutoEventWireup="true"
    CodeFile="SignPk.aspx.cs" Inherits="User_SignPk" %>
        ...
        <tr id="tr_RegData2" runat="server">
            <td align="center">
                <table border="0" cellpadding="4" cellspacing="0" width="300">
                    <tr>
                        <td align="right">
                            <asp:Button ID="BtSignPk" runat="server" Text="修改(R)" AccessKey="R" OnClick="BtSignPk_Click"
                                OnClientClick="return checkNull();" />
                        </td>
                    </tr>
                </table>
            </td>
