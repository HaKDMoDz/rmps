<%@ Page Title="主页" Language="C#" MasterPageFile="~/Amon.master" AutoEventWireup="true" CodeFile="Index.aspx.cs" Inherits="Me.Amon.Index" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="AmonView">
    ...
    <p>
        您还可以找到 <a href="http://go.microsoft.com/fwlink/?LinkID=152368" title="MSDN ASP.NET 文档">MSDN 上有关 ASP.NET 的文档</a>。
    </p>
</asp:Content>
