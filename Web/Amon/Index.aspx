    ...
    <div id="DvBody" style="position: absolute; width: 820px; height: 300px; line-height: 300px; left: 50%; top: 150px; margin-left: -410px; text-align: center; overflow: hidden;">
        <table width="820">
            ...
            <tr>
                ...
                <td align="center" style="height: 42px">
                    <a href="http://amon.me/w/help" class="button cancel" style="color: #666; padding: 10px 20px; font-size: 18px;">使用说明</a> <a href="/About.aspx" class="button cancel" style="color: #666; padding: 10px 20px; font-size: 18px;">了解更多</a>
                </td>
            </tr>
        </table>
    </div>
