...
namespace Me.Amon.Win.Wiz
{
    public partial class InfoCmp : UserControl, ICardCtl
    {
        ...
        public InfoCmp(Awiz mwiz, SafeModel safeModel)
        {
            _Mwiz = mwiz;
        ...
        public void Post(string data)
        {
            ...
            client.UploadStringAsync(new System.Uri(Me.Amon.Const.EnvConst.SERVER_PATH), "POST", "c=" + _SafeModel.Code + "&t=0" + data);
        }
